...
public class EightPartsFrameImage {
    ...
    /*
    public EightPartsFrameImage(ImageZoneSimpleData basicRect, int basicWidth, int basicHeight, int width, int height, PVector leftUpperCorner){
    ...
    public EightPartsFrameImage(Image source, ImageZoneSimpleData basicRect, int basicWidth, int basicHeight, int width, int height, PVector leftUpperCorner){
        mainImage = source;
        init(width, height, leftUpperCorner);
        initBasicDimensions(basicRect, basicWidth, basicHeight);
        initImageZoneData(basicRect);
    ...
    private void init( int width, int height, PVector leftUpperCorner){
